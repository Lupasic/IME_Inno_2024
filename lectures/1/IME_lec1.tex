...
\begin{frame}[c]{Competition: Let's vote}
    ...
    \begin{figure}[H]
        \begin{subfigure}[t]{0.32\textwidth}
            \centering\includegraphics[height=4cm,width=1\textwidth,keepaspectratio]{catapuylt.png}
            \caption{\textbf{Throwing mechanism} \\ Create a stationary mechanism, which can throw the ball as far as can}
            \label{fig:catapuylt.png}
        \end{subfigure}
        \begin{subfigure}[t]{0.32\textwidth}
            \centering\includegraphics[height=4cm,width=1\textwidth,keepaspectratio]{overengineering.jpg}
            \caption{\textbf{OverEngineering} \\ Make a mechanism for putting a teabag into the mug in most complex way}
            \label{fig:overengineering.jpg}
        \end{subfigure}
        \begin{subfigure}[t]{0.32\textwidth}
            \centering\includegraphics[height=4cm,width=1\textwidth,keepaspectratio]{copycat.jpeg}
            \caption{\textbf{Image copier} \\ Create a mechanism for copying picture.}
