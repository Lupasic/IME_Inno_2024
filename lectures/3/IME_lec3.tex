...
\title[IME]{Introduction to Mechanical Engineering, Lecture 3} %% that will be typeset on the
...
\note{\scriptsize \begin{itemize}
        \item объяснить концепцию, что я вам показываю разницу что не надо сейчас думать о том, что у вас за кинемат пара. А нужно думать, о ее возможностях. Это овервью, где я собрал всю инфу. Показать пример поиска инфы с помощью методы в папке.
    \end{itemize}}
